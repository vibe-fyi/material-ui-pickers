...
export declare type WithKeyboardInputProps = DateValidationProps &
  BaseKeyboardPickerProps &
  ExtendWrapper<KeyboardDateInputProps>;
export declare type WithPureInputProps = DateValidationProps &
  BasePickerProps &
...
export declare function makePickerWithState<T extends any>({
  Input,
  useState,
  useOptions,
  getCustomProps,
