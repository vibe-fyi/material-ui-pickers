(function(global, factory) {
  ...
  CircularProgress =
    CircularProgress && CircularProgress.hasOwnProperty('default')
  ...
  */
  ...
  MuiPickersUtilsProvider.propTypes = {
    ...
    children: propTypes_16([propTypes_10.isRequired, propTypes_9(propTypes_10.isRequired)])
      .isRequired,
  };
  ...
  function useOpenState(_ref) {
    ...
    var setIsOpen = React.useCallback(
      function(newIsOpen) {
  ...
  var roundDateToNearest5Minutes = function roundDateToNearest5Minutes(date) {
    var coeff = 1000 * 60 * 5;
  ...
  function usePickerState(props, options) {
    ...
    var acceptDate = React.useCallback(
    ...
    var wrapperProps = React.useMemo(
      function() {
        return {
          format: format,
          open: isOpen,
          ...
          onSetToday: function onSetToday() {
            return setPickerDate(roundDateToNearest5Minutes(utils.date()));
          },
  ...
  var dateTimePickerDefaultProps = _objectSpread$2(
    {},
  ...
  function useKeyboardPickerState(props, options) {
    ...
    var handleKeyboardChange = React.useCallback(
      function(date) {
  ...
  var timeoutsShape = propTypes.oneOfType([
    propTypes.number,
    propTypes.shape({
  ...
  var classNamesShape = propTypes.oneOfType([
    propTypes.string,
    propTypes.shape({
  ...
  var ModalWrapper = function ModalWrapper(_ref) {
    ...
    return React.createElement(
      React.Fragment,
      null,
      React.createElement(InputComponent, _extends({}, other, DateInputProps)),
      React.createElement(
        ModalDialog$1,
        _extends(
          {
